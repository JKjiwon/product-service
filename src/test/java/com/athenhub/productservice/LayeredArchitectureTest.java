...
@AnalyzeClasses(
    packages = "com.athenhub.productservice",
    importOptions = ImportOption.DoNotIncludeTests.class)
class LayeredArchitectureTest {

  private static final String[] DOMAIN_PACKAGES = {
    "com.athenhub.productservice.example.domain..",
  };
  ...
  public void layeredArchitecture(JavaClasses classes) {
    Architectures.layeredArchitecture()
        ...
        .layer("Presentation")
        .definedBy("com.athenhub.productservice..presentation..")
        .layer("Application")
        .definedBy("com.athenhub.productservice..application..")
        .layer("Domain")
        .definedBy("com.athenhub.productservice..domain..")
        .layer("Infrastructure")
        .definedBy("com.athenhub.productservice..infrastructure..")
        ...
        .ignoreDependency(
            ...
            JavaClass.Predicates.resideInAPackage("com.athenhub.productservice.global.."))
        // 빈 레이어 허용
  ...
  public void globalShouldNotDependOnDomains(JavaClasses classes) {
    ...
    // global 패키지가 없으면 스킵
    if (!hasClassesInPackage(classes, "com.athenhub.productservice.global..")) {
      return;
    }

    noClasses()
        .that()
        .resideInAPackage("com.athenhub.productservice.global..")
        .should()
        .dependOnClassesThat()
